...
class CallbackFlowManager:
    ...
    def get_next_collection_prompt(self, session: ConversationSession) -> str | None:
        ...
        elif state == CollectionState.COLLECTING_PHONE.value:
            return "What's your phone number?"

        elif state == CollectionState.COLLECTING_NAME.value:
            return "May I have your name? (You can skip this if you prefer)"

        elif state == CollectionState.COLLECTING_TIME.value:
    ...
    def advance_state(self, session: ConversationSession, extracted_data: dict, action: str):
        ...
        if action == "cancel":
            ...
            self.state_manager.update_collection_state(
                session.session_id, CollectionState.COLLECTING_PHONE
            )
            ...
            if current_state == CollectionState.OFFERING.value:
            ...
            elif current_state == CollectionState.COLLECTING_PHONE.value:
                ...
                self.state_manager.update_collection_state(
                    session.session_id, CollectionState.COLLECTING_NAME
                )

            elif current_state == CollectionState.COLLECTING_NAME.value:
                ...
                self.state_manager.update_collection_state(
                    session.session_id, CollectionState.COLLECTING_TIME
                )

            elif current_state == CollectionState.COLLECTING_TIME.value:
