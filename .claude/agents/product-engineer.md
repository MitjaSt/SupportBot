...
- Trying to find support services (the Macular Society helpline)
- Using assistive technology (screen reader, voice control, magnification software)
- Not technically confident

**The product promise:** Give clear, trustworthy answers about macular degeneration, grounded in Macular Society knowledge. Connect people to human support when they need it.
...
- Does it make it clear when information comes from Macular Society content (retrieved) vs model generation?
...
- The contact collection feature exists so users can request a callback from Macular Society support staff.
