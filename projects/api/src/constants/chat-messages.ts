export const ChatMessages = {
  ...
  contactCollected: (type: 'phone' | 'email', value: string): string =>
    `Thank you for providing your ${type === 'phone' ? 'phone number' : 'email address'}. Someone from the RAG Project will contact you at ${value} on the next working day to discuss your query.`,
} as const;
